...
interface IGlObject {
    ...
    _glPositionBuffer:     any;             // Position buffer for gl
    _glNormalBuffer:       any;             // Normal buffer for gl
    _glTextureCoordBuffer: any;             // Texture cooordinate buffer for gl
    _glVertexIndexBuffer:  any;             // Vertex buffer for gl
...
class GlObject implements IGlObject {
    ...
    **/
    render() {
        let gl:            any = this._renderer.getGl();
        let shaderProgram: any = this._renderer.getShaderProgram();
