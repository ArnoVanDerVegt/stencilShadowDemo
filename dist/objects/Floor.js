    ...
    createObject(sizeX, sizeY, sizeZ) {
        ...
        for (let z = 0; z < sizeZ; z++) {
            ...
            for (let x = 0; x < sizeX; x++) {
                ...
                x2 = x1 + tileSize;
                this
                    .addTriangle(x1, getY(x1, z2), z2, getUV(x), getUV(z + 1), x2, getY(x2, z2), z2, getUV(x + 1), getUV(z + 1), x2, getY(x2, z1), z1, getUV(x + 1), getUV(z))
                    .addTriangle(x1, getY(x1, z2), z2, getUV(x), getUV(z + 1), x2, getY(x2, z1), z1, getUV(x + 1), getUV(z), x1, getY(x1, z1), z1, getUV(x), getUV(z));
            }
        }
